...
namespace MiiEngine {
	...
	private:
		...
		std::unique_ptr<ParticleHistory> historyManager_;     // 編集履歴管理
	...
	private:
		...
		/// </summary>
		bool DragFloatWithHistory(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f);
